          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            ...
            {preview_url && (
              <div
                ...
                className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer mr-2 hover:scale-110 transition-transform"
                title="Live Preview"
              >
        ...
        <div className="mt-5">
          ...
          <div className="mt-3 flex flex-wrap gap-4 text-xs">
            <div className="flex items-center gap-1">
              ...
              <span className="text-green-400">Data Processed</span>
            </div>
            <div className="flex items-center gap-1">
              <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
              <span className="text-blue-400">Insights Generated</span>
            </div>
            <div className="flex items-center gap-1">
              <span className="w-2 h-2 bg-purple-500 rounded-full"></span>
              <span className="text-purple-400">Visualizations</span>
            </div>
          </div>
        </div>
